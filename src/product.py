...
class Product:
    ...
    def add_product(self):
        ...
        cur.execute('INSERT INTO product(name, description, unit_price, quantity, alert_threshold, last_entry_date, last_release_date, stock_id) VALUES(%s, %s, %s, %s, %s, %s, %s, %s)', self.name, self.description, self.unit_price, self.quantity, self.alert_threshold, self.last_entry_date, self.last_release_date, stock_id)
        conn.commit()
    ...
    def delete_product(self):
        print("delete: " + str(self.product_id))
    
    def update_product(self):
        print("update: " + str(self.product_id))
